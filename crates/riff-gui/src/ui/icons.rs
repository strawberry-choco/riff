...
pub enum Icon {
    ...
    Expand,
    /// The Lucide corner-bracket collapse glyph (fullscreen/expand button
    /// while the enlarged view is up).
    Collapse,
    Folder,
    FolderOpen,
    Heart,
...
impl Icon {
    ...
    pub fn asset_name(self) -> &'static str {
        match self {
            ...
            Self::Collapse => "minimize-corners",
            Self::Folder => "folder",
    ...
    pub fn svg(self) -> &'static str {
        match self {
            ...
            Self::Collapse => include_str!("../../assets/icons/minimize-corners.svg"),
            Self::Folder => include_str!("../../assets/icons/folder.svg"),
            Self::FolderOpen => include_str!("../../assets/icons/folder-open.svg"),
            Self::Heart => include_str!("../../assets/icons/heart.svg"),
            Self::Library => include_str!("../../assets/icons/library.svg"),
            Self::LayoutGrid => include_str!("../../assets/icons/layout-grid.svg"),
