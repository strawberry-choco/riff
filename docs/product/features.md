...
| Progressive Disclosure | Advanced mode reveals tag editing, the Advanced-only smart lists, and the stop control | implemented | P1 | Player Control Bar, Tag Writing, Smart Playlists |
